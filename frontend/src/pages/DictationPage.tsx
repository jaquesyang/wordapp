...
export function DictationPage() {
  ...
  const handleToggleAll = () => {
    if (units && selectedUnits.length === (units as any).length) {
      setSelectedUnits([]);
    } else {
      setSelectedUnits((units as any)?.map((u: any) => u.unit) || []);
    }
  };
      ...
      <div className="min-h-screen bg-background">
        <div className="max-w-2xl mx-auto py-8">
          <div className="mb-6 flex items-center justify-between">
            ...
            {isPaused && (
              <div className="text-center text-muted-foreground">已暂停</div>
            )}
            <div></div>
          </div>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => settings.dictationWordInterval > 1 && updateSettings({ dictationWordInterval: settings.dictationWordInterval - 1 })}
                    >
                      -
                    </Button>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => settings.dictationWaitTime > 1 && updateSettings({ dictationWaitTime: settings.dictationWaitTime - 1 })}
                    >
                      -
                    </Button>
                ...
                <div className="flex items-center justify-between">
                  ...
                  <div className="flex items-center gap-2">
                    <Button
                      variant="outline"
                      size="sm"
                      onClick={() => settings.letterInterval > 0.1 && updateSettings({ letterInterval: Math.round((settings.letterInterval - 0.1) * 10) / 10 })}
                    >
                      -
                    </Button>
