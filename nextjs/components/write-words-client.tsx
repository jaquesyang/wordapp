...
interface WriteWordsClientProps {
  grade: string;
  units: Unit[];
}
    ...
    <div className="space-y-6">
      ...
      <Card>
        <CardContent className="p-8 text-center">
          <p className="text-2xl text-card-foreground mb-4">{currentWord.chinese_definition}</p>
          {currentWord.phonetic && <p className="text-muted-foreground mb-2">{currentWord.phonetic}</p>}
